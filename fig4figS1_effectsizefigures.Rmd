...
```{r}
effectsize_final <- read.csv("Final Spreadsheet/effectsizesforfig_final2.csv", stringsAsFactors = TRUE, na.strings=c(""))
...
Now, based on further analysis, there are some differences in how the phylotypes within Lactobacillales react to pesticide exposure, so we're going to make another figure that shows the differences between the Firm-4 and Firm-5 phylotypes.
...
Annotate the figure so that there is one common y-axis.
