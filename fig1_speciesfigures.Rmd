...
```{r}
allbeetaxa <- read.csv("Pesticide Bee Review/Stats/bees.csv", stringsAsFactors = TRUE, na.strings=c(""))
...
## Figure 1C: Bar Chart of Pesticides Studied in Each Bee Species (Recent Studies)
...
speciespesticide %>% 
  ...
  theme(text = element_text(size = 16, color = "black"), 
        ...
        axis.title.y = element_text(size = 20, color = "black", margin = margin(t = 0, r = 20, b = 0, l = 0)),
        axis.title.x = element_text(size = 20, color = "black", margin = margin(t = 20, r = 0, b = 0, l = 0)))+
  scale_x_discrete(name="Species")+
  scale_y_continuous(name ="Number of Pesticides Examined", 
                     breaks = seq(0, 20, len = 6), 
                     expand = c(0, 0),
                     limits = c(0,18))+
  scale_fill_manual(values=c("#FC6471", "#FFD930", "#00BBFF", "#2372D9", "#3DCC00"))+
  labs(fill = "Species")
```
